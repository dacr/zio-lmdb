...
```scala
libraryDependencies += "fr.janalyse" %% "keycodecs-timestamp" % "2.8.6"
```
...
```scala
libraryDependencies += "fr.janalyse" %% "keycodecs-uuidv7" % "2.8.6"
```
...
```scala
libraryDependencies += "fr.janalyse" %% "keycodecs-ulid" % "2.8.6"
```
...
```scala
libraryDependencies += "fr.janalyse" %% "keycodecs-geo" % "2.8.6"
```
...
```scala
libraryDependencies += "fr.janalyse" %% "keycodecs-uca" % "2.8.6"
```
