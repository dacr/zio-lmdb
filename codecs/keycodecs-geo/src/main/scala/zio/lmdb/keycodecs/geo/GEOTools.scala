...
object GEOTools {
  ...
  /** Great-circle distance, in metres, between two latitude/longitude points using the haversine formula on a sphere of [[EarthRadiusMeters]]. Accurate to a few tenths of a percent — ample for "within a radius" filtering. Inputs are decimal degrees.
    */
